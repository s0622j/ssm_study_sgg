...
import com.atguigu.ioc06.controller.StudentController;
...
public class spring01_ioc06 {
    ...
    public void testForIoC(){
        ...
        ApplicationContext applicationContext
                = new ClassPathXmlApplicationContext("spring-bean-06-01.xml");
        //2.获取jdbcTemplate组件
    ...
    public void testQueryAll(){
        ...
        ClassPathXmlApplicationContext applicationContext
                = new ClassPathXmlApplicationContext("spring-bean-06-02.xml");
        //2.获取组件对象
